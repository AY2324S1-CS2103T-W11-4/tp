...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("developer")]),_v(" "),_c('td',[_v("view all members of my team")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("project manager")]),_v(" "),_c('td',[_v("access the names of all my")]),_v(" "),_c('td',[_v("them regarding the project")])])])])])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true},[_v("                                                      deveopers and team leaders     \n")])])}
},function anonymous(
) {
with(this){return _c('p',[_v("| "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")]),_v("  | project manager                            | assign a node for a team     |   the target team leaders can fill in their information by themselves  |\nleader\n| "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")]),_v("  | user                                       | find a person by name        | locate details of persons without having to go through the entire list |\n| "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")]),_v("    | developer                                  | hide private contact details | minimize chance of someone else seeing them by accident                |\n| "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")]),_v("      | user with many persons in the address book | sort persons by name         | locate a person easily                                                 |")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Thu, 5 Oct 2023, 15:06:25 GMT+8]")])])])}
}];
